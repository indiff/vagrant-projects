...
21c Grid Infrastructure and FPP Server host + (optional) an Oracle FPP target, using Vagrant, Oracle Linux 8 and shell scripts.
...
Note: due to ACFS FPP usage, kernel-uek-5.4.17 is in use
