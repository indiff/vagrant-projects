...
19c Grid Infrastructure and FPP Server host + (optional) an Oracle FPP target, using Vagrant, Oracle Linux 7 and shell scripts.
...
(*) Download Grid Infrastructure and Database binary 19c from OTN into `ORCL_software` folder
https://www.oracle.com/database/technologies/oracle-database-software-downloads.html
    ...
    * Oracle Database 19c Grid Infrastructure (19.3) for Linux x86-64
        LINUX.X64_193000_grid_home.zip (2,422,217,613 bytes)
        (sha256sum - 070d4471bc067b1290bdcee6b1c1fff2f21329d2839301e334bcb2a3d12353a3)

    * Oracle Database 19c (19.3) for Linux x86-64 (required with 19c FPP)
       LINUX.X64_193000_db_home.zip (3,109,225,519 bytes)
