#！/bin/bash
# 本脚本用于为 Oracle ASMFD 设备打标签，适用于 VirtualBox、libvirt 等虚拟化环境
#│▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒
#
# LICENSE UPL 1.0
#
...
# 设置 Oracle Grid Infrastructure 环境变量
export ORACLE_HOME=${GI_HOME}
export ORACLE_BASE=/tmp


# 为每块磁盘的第一个分区打 ASMFD 标签
