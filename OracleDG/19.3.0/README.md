...
2. Download the Oracle Database 19c Enterprise Edition installer zip from [Oracle](https://www.oracle.com/database/technologies/oracle19c-linux-downloads.html).
...
cd vagrant-projects/OracleDG/19.3.0

# 1. Put the Oracle 19c zip in ORCL_software/
