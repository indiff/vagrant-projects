# 🚀 Oracle Globally Distributed Database 23ai on Vagrant (OL9)

![Oracle GDD overview](.images/OracleGDD.png)

> Automated Vagrant lab for Oracle Linux 9 that provisions a single VM and deploys an Oracle Globally Distributed Database (GDD) topology on Podman.

## ✨ What This Project Delivers

| Layer | What you get |
| --- | --- |
| Virtualization | One Oracle Linux 9 VM on `virtualbox` or `libvirt` |
...
1. Clone the parent project and enter this directory.
   ...
   cd vagrant-projects/OracleGDD/OL9
   ```
